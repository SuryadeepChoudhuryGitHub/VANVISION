    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-4 flex flex-col h-full">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900">Priority Attention Districts</h3>
            <p className="text-[11px] text-slate-500">Highest composite risk & administrative SLA backlog</p>
          </div>
        </div>
        <Link
          to="/districts"
          ...
          return (
            <div
              ...
              className={`p-3 rounded-lg border transition-all cursor-pointer flex items-center justify-between gap-3 ${
                isSelected
                  ? 'border-forest-700 bg-forest-50/50 shadow-xs ring-1 ring-forest-700/20'
                  : 'border-slate-200 bg-slate-50/60 hover:bg-slate-100 hover:border-slate-300'
              }`}
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-slate-900 text-xs truncate">{district.name}</span>
                  <span className="text-[11px] text-slate-500 truncate">({district.state})</span>
                </div>
                ...
                <div className="flex items-center gap-3 mt-1.5 text-[10px] text-slate-500 font-mono">
                  ...
                  <span>•</span>
                  <span>Anomalies: <b className="text-rose-600">{district.activeAnomalies}</b></span>
                  <span>•</span>
