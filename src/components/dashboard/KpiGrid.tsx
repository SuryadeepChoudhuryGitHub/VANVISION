  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Card 1: Total Claims */}
        {isVisible('total') && (
          <div className="kpi-card bg-white rounded-xl p-4 sm:p-5 border border-slate-200 border-l-4 border-l-emerald-600 shadow-xs hover:shadow-md transition-all flex flex-col justify-between group">
            <div>
              <div className="flex items-center justify-between gap-2 mb-2">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-500">
                  Total Claims Registered
                </span>
                <div className="p-2 rounded-lg bg-emerald-50 text-emerald-800 border border-emerald-200/80 shrink-0">
                  <FileText className="w-4 h-4" />
                </div>
              </div>
              <div className="text-3xl font-black tracking-tight text-slate-900 font-mono leading-none">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
              ...
              <Link
                to="/claims"
                className="text-[11px] font-semibold text-emerald-800 hover:text-emerald-950 flex items-center gap-0.5 group-hover:translate-x-0.5 transition-transform"
              >
                <span>Registry</span>
        ...
        {isVisible('approved') && (
          <div className="kpi-card bg-white rounded-xl p-4 sm:p-5 border border-slate-200 border-l-4 border-l-teal-600 shadow-xs hover:shadow-md transition-all flex flex-col justify-between group">
            <div>
              <div className="flex items-center justify-between gap-2 mb-2">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-500">
                  Titles Conferred
                </span>
                <div className="p-2 rounded-lg bg-teal-50 text-teal-800 border border-teal-200/80 shrink-0">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
              </div>
              <div className="text-3xl font-black tracking-tight text-teal-800 font-mono leading-none">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
              <span className="px-2 py-0.5 rounded-full font-bold bg-teal-50 text-teal-800 border border-teal-200 text-[11px]">
                {formatPercent(stats.approvalRate)} Titling Rate
              </span>
              <span className="text-[11px] text-slate-400 font-medium">Sec. 3(1) Saturation</span>
            </div>
          </div>
        )}
        ...
        {isVisible('pending') && (
          <div className="kpi-card bg-white rounded-xl p-4 sm:p-5 border border-slate-200 border-l-4 border-l-amber-500 shadow-xs hover:shadow-md transition-all flex flex-col justify-between group">
            <div>
              <div className="flex items-center justify-between gap-2 mb-2">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-500">
                  Active Pipeline
              ...
              <div className="text-3xl font-black tracking-tight text-amber-800 font-mono leading-none">
        ...
        {isVisible('anomalies') && (
          <div className="kpi-card bg-white rounded-xl p-4 sm:p-5 border border-slate-200 border-l-4 border-l-rose-600 shadow-xs hover:shadow-md transition-all flex flex-col justify-between group">
            <div>
              <div className="flex items-center justify-between gap-2 mb-2">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-500">
                  Active Anomalies Flagged
                </span>
                <div className="p-2 rounded-lg bg-rose-50 text-rose-800 border border-rose-200/80 shrink-0">
                  <AlertTriangle className="w-4 h-4" />
                </div>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-3xl font-black tracking-tight text-rose-700 font-mono leading-none">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
              <span className="text-[11px] text-rose-700 font-medium">Requires SLMC action</span>
              <Link
                to="/anomalies?severity=Critical"
                className="text-[11px] font-semibold text-rose-800 hover:text-rose-950 flex items-center gap-0.5 group-hover:translate-x-0.5 transition-transform"
              >
      ...
      {settings.showSecondaryMetrics && (
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-xs grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          {/* Adjudication Distribution Progress */}
          <div className="space-y-1.5 pr-0 md:pr-4 border-b md:border-b-0 md:border-r border-slate-100 pb-3 md:pb-0">
          ...
          <div className="space-y-1.5 px-0 md:px-2 border-b md:border-b-0 md:border-r border-slate-100 pb-3 md:pb-0">
            <div className="flex items-center justify-between font-semibold text-slate-700">
              <span className="flex items-center gap-1.5">
          ...
          <div className="space-y-1.5 pl-0 md:pl-2 flex flex-col justify-between">
            <div className="flex items-center justify-between font-semibold text-slate-700">
              ...
              <Link to="/districts" className="text-blue-700 hover:underline font-semibold text-[11px]">
                52 Districts →
              </Link>
            </div>
